...
public enum Text
{
    ...
    UNKNOWN_DESCRIPTION(""),
    QUIT("quit"),
    QUIT_DESCRIPTION("Exit hte game"),
    GO("go"),
    UNKNOWN("unknown"),
    USE("use"),
    HELP("help"),
    HELP_MESSAGE("Enter one of the following commands followed by a modifier if appropriate: "),
    GO_DESCRIPTION("<direction> : Player goes to the exit in the direction you type."),
    USE_DESCRIPTION(" <object> use the object you type in"),
    HELP_DESCRIPTION(" lists the commands you can use."),
    INTERACT("interact"),
    ...
    WELCOME("Welcome to 508 Superstition: Escape From Hod! Enter "+HELP+" if you do not know how to play."),
